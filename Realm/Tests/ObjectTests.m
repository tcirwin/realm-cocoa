...
- (void)testAddingObjectWithoutAnyPropertiesThrows {
    ...
    [realm beginWriteTransaction];
    RLMAssertThrowsWithReasonMatching([realm addObject:[[AbstractObject alloc] initWithValue:@[]]], @"Can't add objects of type 'AbstractObject' to the Realm as the class doesn't define any persisted properites.");
    RLMAssertThrowsWithReasonMatching([AbstractObject createInRealm:realm withValue:@[]], @"Can't add objects of type 'AbstractObject' to the Realm as the class doesn't define any persisted properites.");
    [realm cancelWriteTransaction];
}
